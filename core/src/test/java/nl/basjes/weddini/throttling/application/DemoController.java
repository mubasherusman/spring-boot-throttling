...
public class DemoController {
    ...
    @GetMapping(value = "/SpEl/{userName}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = "/remoteAddr/{userName}", produces = MediaType.APPLICATION_JSON_VALUE)
